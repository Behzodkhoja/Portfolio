...
const Sidebar = () => {
    ...
    return (
        <div id='sidebar' className={`${show && 'scroll_navbar'} border-bottom`}>
            ...
            >
                <div className={`p-2 position-relative d-flex flex-column h-100vh ${isOpen ? '' : 'l--50'}`}>
                    <div>
                        ...
                        <div className='my-4'>
                            <p
                                className='fs-xl-16 p-regular opacity-75'
                        ...
                        <div className='my-2'>
                            <hr style={{ backgroundColor: '#dce1e4', height: '3px' }} />
                        </div>
                        <div className='my-2'>
                            <Nav navbar>
                                {SidebarData.map(data => (
