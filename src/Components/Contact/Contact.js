                ...
                <Row className='my-5'>
                                    ...
                                    <div>
                                        ...
                                        <CardText tag='span'>
                                            <div className='d-flex'>
                                                ...
                                                <Link
                                                    url='tel:998998200155'
                                                    words='+998 99 820-01-55'
                                                    contact
                                                />
                                            </div>
                                            <div className='d-flex text-truncate'>
                                                ...
                                                <Link
                                                    url='mailto:nigmatxojayevbehzodxoja@gmail.com'
                                                    words='nigmatxojayevbehzodxoja@gmail.com'
                                                    contact
                                                />
                                            </div>
                                        </CardText>
                    ...
                    >
                        <div className='bg-color-1 box-shadow p-4 borr-10' data-aos='fade-right'>
                            <form
                                className='color-body text-uppercase fs-xl-12 p-medium font-secondary text-start'
                            ...
                            >
                                ...
                                <Button
                                    type='submit'
                                    className='d-flex align-items-center justify-content-center w-100 cursor-pointer borr-6 bg-color-1 box-shadow fs-14 p-medium color-primary font-primary text-uppercase border-0 hover-bg-color-1 hover-color-white'
                                    disabled={loading}
                                >
