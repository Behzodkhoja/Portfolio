...
const ResumeCart = ({ h4, years, text }) => {
    return (
        <div className='box-shadow bg-color-1 p-lg-4 p-xl-5 p-xl-5 p-3 time-table borr-6 hover-bg-color-1 hover'>
            <div className='line' />
            <div className='d-xl-flex d justify-content-between'>
                <div>
                    ...
                    <span className='color-body d-block fs-xl-14 fs-14'>{years}</span>
                </div>
            </div>
